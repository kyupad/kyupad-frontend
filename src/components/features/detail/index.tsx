...
// import RegisteredView from '@/components/common/detail/registedView';
...
const Detail = () => {
  ...
  const initData: Data = {
    ...
    investment: {
      timer: '2024-03-21T18:00:00',
      invested: false, // trạng thái đã đầu tư
      timeEnded: true, // trạng thái thời gian đầu tư
