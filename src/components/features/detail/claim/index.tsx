...
const InvesmentView = () => {
  ...
  return (
    <>
      <div className="py-5 w-full max-w-8xl mx-auto p-4">
        <HeadDetail
          image={image}
          CoinName={coinName}
        ...
        <ModalItems className="border-2 border-black rounded-lg bg-[#EEEDF1] py-3 px-6 w-full mt-6">
        ...
        <div className="flex relative">
          ...
          <Image
            src="images/detail/money-cat.svg"
      ...
      <Image
        ...
        alt="sad cat"
        fill
        className="!-bottom-0 !inset-[unset] !h-auto !w-screen -z-10"
      />
    </>
  );
};
