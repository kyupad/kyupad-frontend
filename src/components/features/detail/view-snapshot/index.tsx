      ...
      <div className="w-full max-w-8xl mx-auto px-4 lg:px-[60px] flex gap-4 pb-[210px] items-center justify-center flex-col lg:flex-row">
        <div className="flex flex-col gap-4 w-full">
          ...
          <div className="flex gap-5 items-center">
            <div className="min-w-[100px] min-h-[100px] sm:min-h-[150px] sm:min-w-[150px] xl:min-w-[200px] rounded-full xl:min-h-[200px] border-2 border-kyu-color-4 overflow-hidden relative">
              <ImageNext
                className="absolute"
                src={data?.logo}
                alt="project logo"
